        ...
        content
            ...
            .alert(FolderChooserSettings.folderNameTitle.vcsLocalized, isPresented: $isPresented, actions: {
                ...
                Button(FolderChooserSettings.createButtonTitle.vcsLocalized, action: {
                    guard let currentFolder = currentFolder //?? FolderChooser.currentSharedWithMeFolderRouteData?.folderResponse ?? FolderChooser.currentFolderRouteData?.folderResponse
                    else { return }
