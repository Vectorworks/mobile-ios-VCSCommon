...
//        return VCSMountPointResponse(storageType: StorageType.typeFromString(type: self.storageType), prefix: self.prefix, path: self.path, mountPath: self.mountPath, modelID: self.RealmID)
//    }
//    
